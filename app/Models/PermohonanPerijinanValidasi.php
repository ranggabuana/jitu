...
class PermohonanPerijinanValidasi extends Model
{
    protected $table = 'permohonan_perijinan_validasi';

    protected $fillable = [
        'permohonan_perijinan_id',
        'validation_flow_id',
        'user_id',
        'status',
        'catatan',
    ...
    {
        return $this->belongsTo(PermohonanPerijinan::class, 'permohonan_perijinan_id');
    }
