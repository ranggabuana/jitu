...
class AplikasiPerijinan extends Model
{
    use HasFactory;

    protected $table = 'aplikasi_perijinan';
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($aplikasi) {
            if (empty($aplikasi->no_registrasi)) {
    ...
    {
        return $this->hasMany(AplikasiPerijinanValidasi::class)->orderBy('order');
    }
    ...
    {
        return $this->hasMany(AplikasiPerijinanValidasi::class)->where('status', 'pending');
    }
    ...
    {
        return $this->hasMany(AplikasiPerijinanValidasi::class)
    ...
    {
        return $this->hasMany(AplikasiPerijinanValidasi::class)->where('status', 'approved');
    }
