...
class PermohonanPerijinan extends Model
{
    ...
    protected $table = 'permohonan_perijinan';
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($permohonan) {
            if (empty($permohonan->no_registrasi)) {
    ...
    {
        return $this->hasMany(PermohonanPerijinanValidasi::class, 'permohonan_perijinan_id')->orderBy('order');
    }
    ...
    {
        return $this->hasMany(PermohonanPerijinanValidasi::class, 'permohonan_perijinan_id')->where('status', 'pending');
    }
    ...
    {
        return $this->hasMany(PermohonanPerijinanValidasi::class, 'permohonan_perijinan_id')
    ...
    {
        return $this->hasMany(PermohonanPerijinanValidasi::class, 'permohonan_perijinan_id')->where('status', 'approved');
    }
