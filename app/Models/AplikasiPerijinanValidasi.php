...
class AplikasiPerijinanValidasi extends Model
{
    protected $table = 'aplikasi_perijinan_validasi';

    protected $fillable = [
        'aplikasi_perijinan_id',
        'validation_flow_id',
        'user_id',
        'status',
        'catatan',
    ...
    {
        return $this->belongsTo(AplikasiPerijinan::class, 'aplikasi_perijinan_id');
    }
