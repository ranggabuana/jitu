<x-front-layout>
    ...
    <section class="py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @if ($layanan->count() > 0 || $includePencabutanMedis || $includeOperasionalPendidikan || $includePendirianPendidikan)
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    @if($includeOperasionalPendidikan && request('page', 1) == 1)
                        ...
                        <div class="cursor-pointer group" onclick="openOperasionalModal()">
                            <div class="bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-purple-100 h-full flex flex-col justify-between">
                                <div class="p-6 flex-1">
                                    <div class="flex items-center gap-4 mb-4">
                                ...
                                <div class="px-6 pb-6 pt-4 border-t border-gray-100 flex items-center justify-between">
                                    ...
                                    <span class="inline-flex items-center gap-2 text-purple-600 font-semibold text-sm group-hover:gap-3 transition-all">
                                        Lihat Daftar <i class="fas fa-arrow-right"></i>
                                    </span>
                                </div>
                            </div>
                    ...
                    @if($includePendirianPendidikan && request('page', 1) == 1)
                        ...
                        <div class="cursor-pointer group" onclick="openPendirianModal()">
                            <div class="bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-emerald-100 h-full flex flex-col justify-between">
                                <div class="p-6 flex-1">
                                    <div class="flex items-center gap-4 mb-4">
                                ...
                                <div class="px-6 pb-6 pt-4 border-t border-gray-100 flex items-center justify-between">
                                    ...
                                    <span class="inline-flex items-center gap-2 text-emerald-600 font-semibold text-sm group-hover:gap-3 transition-all">
                                        Lihat Daftar <i class="fas fa-arrow-right"></i>
                                    </span>
                                </div>
                            </div>
    ...
    <div id="operasionalModal" class="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 hidden items-center justify-center p-4">
        <div class="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[85vh] overflow-hidden flex flex-col transform transition-all duration-300 scale-95 opacity-0" id="operasionalModalContent">
            <!-- Header -->
            <div class="bg-gradient-to-br from-purple-600 via-purple-700 to-purple-800 text-white p-6 flex-shrink-0 flex justify-between items-center">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-purple-100 text-xs mt-0.5">Pilih jenis perizinan operasional pendidikan yang Anda inginkan</p>
                    </div>
                </div>
            ...
            <div class="flex-1 overflow-y-auto p-6 space-y-3 bg-gray-50">
                @foreach($operasionalPendidikanItems as $operasionalItem)
                    <a href="{{ route('layanan.show', $operasionalItem->id) }}" class="block bg-white hover:bg-purple-50/30 p-4 rounded-xl border border-gray-200 hover:border-purple-300 transition-all shadow-sm hover:shadow-md group">
                        <div class="flex items-center justify-between">
                            <div class="flex-1 pr-4">
    ...
    <div id="pendirianModal" class="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 hidden items-center justify-center p-4">
        <div class="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[85vh] overflow-hidden flex flex-col transform transition-all duration-300 scale-95 opacity-0" id="pendirianModalContent">
            <!-- Header -->
            <div class="bg-gradient-to-br from-emerald-600 via-emerald-700 to-emerald-800 text-white p-6 flex-shrink-0 flex justify-between items-center">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-emerald-100 text-xs mt-0.5">Pilih jenis perizinan pendirian pendidikan yang Anda inginkan</p>
                    </div>
                </div>
            ...
            <div class="flex-1 overflow-y-auto p-6 space-y-3 bg-gray-50">
                @foreach($pendirianPendidikanItems as $pendirianItem)
                    <a href="{{ route('layanan.show', $pendirianItem->id) }}" class="block bg-white hover:bg-emerald-50/30 p-4 rounded-xl border border-gray-200 hover:border-emerald-300 transition-all shadow-sm hover:shadow-md group">
                        <div class="flex items-center justify-between">
                            <div class="flex-1 pr-4">
