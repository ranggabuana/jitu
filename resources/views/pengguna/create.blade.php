<x-layout>
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600 dark:text-gray-400 mt-1">Tambah pengguna baru ke sistem</p>
    </div>

    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 max-w-4xl">
        <form action="{{ route('pengguna.data.store') }}" method="POST">
            @csrf
            ...
            <div class="mb-6" id="opd_container" style="display: none;">
