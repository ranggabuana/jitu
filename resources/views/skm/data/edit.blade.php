<x-layout>
    <x-slot:title>Edit Pertanyaan SKM</x-slot:title>
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Edit Pertanyaan SKM</h1>
        <p class="text-gray-600 dark:text-gray-400 mt-1">Perbarui pertanyaan Survey Kepuasan Masyarakat</p>
    </div>

    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 max-w-4xl">
        <form action="{{ route('skm.data.update', $dataSkm->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <textarea id="pertanyaan" name="pertanyaan" rows="3"
                    ...
                    placeholder="Masukkan pertanyaan">{{ old('pertanyaan', $dataSkm->pertanyaan) }}</textarea>
                @error('pertanyaan')
            ...
            <div class="mb-6 max-w-md">
                ...
                <select id="status" name="status"
                    ...
                    <option value="aktif" {{ old('status', $dataSkm->status) === 'aktif' ? 'selected' : '' }}>Aktif</option>
                    <option value="tidak_aktif" {{ old('status', $dataSkm->status) === 'tidak_aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                </select>
                @error('status')
                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                @enderror
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 pt-6 mt-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="opsi_1" name="opsi_1" value="{{ old('opsi_1', $dataSkm->opsi_1 ?: 'Kurang Baik') }}" placeholder="Kurang Baik"
                    ...
                    <div>
                        ...
                        <input type="text" id="opsi_2" name="opsi_2" value="{{ old('opsi_2', $dataSkm->opsi_2 ?: 'Cukup Baik') }}" placeholder="Cukup Baik"
                    ...
                    <div>
                        ...
                        <input type="text" id="opsi_3" name="opsi_3" value="{{ old('opsi_3', $dataSkm->opsi_3 ?: 'Baik') }}" placeholder="Baik"
                    ...
                    <div>
                        ...
                        <input type="text" id="opsi_4" name="opsi_4" value="{{ old('opsi_4', $dataSkm->opsi_4 ?: 'Sangat Baik') }}" placeholder="Sangat Baik"
